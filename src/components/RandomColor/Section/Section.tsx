...
const Section = ({
  ...
  const onClickColor = () => {
    ...
    if (spanRef.current) {
      spanRef.current.classList.add(`${styles.clicked}`);
      setTimeout(() => {
        if (spanRef.current) {
          spanRef.current.classList.remove(`${styles.clicked}`);
        }
      }, 1000);
    }
  };
    ...
    >
      <div className={styles.text}>
        <p onClick={onClickColor}>
          {bgColor}
          <span ref={spanRef} className={styles.not_clicked}>
            Copied to clipboard
          </span>
        </p>
        ...
        >
          {!locked ? (
            <svg
              ...
              width="3rem"
              height="3rem"
              viewBox="0 0 1280.000000 1235.000000"
            ...
            >
              ...
              <g
                transform="translate(0.000000,1235.000000) scale(0.100000,-0.100000)"
                stroke="none"
              >
                <path
                  d="M9250 12340 c-529 -51 -983 -199 -1432 -468 -528 -316 -983 -818
...
27 -674 15z"
            ...
            >
              ...
              >
                <path
                  d="M5610 11999 c-1096 -88 -1924 -626 -2375 -1544 -80 -162 -155 -347
